...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/reports/{id}/confirm": {
            "post": {
                "description": "Casts one of four votes against a report: confirm/dispute are content votes (is\nthis report still true), resolve/reopen are resolution votes (is this resolved).\nRequires a session verified by email through the magic-link flow; an unverified\ncaller receives 401. The reporter receives 403 on confirm/dispute but may resolve\nor reopen their own report instantly. The response carries the freshly recomputed\nvisibility and reason so the client can render the outcome without guessing.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "Voter's current coordinates",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CastVoteRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.CastVoteResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "handlers.ReportResponse": {
            ...
            "properties": {
                ...
                "distance_km": {
                    "description": "DistanceKm is present only in GET /api/reports responses (nil on the report just submitted).",
                    "type": "number",
                    "example": 1.42
                },
                "expires_at": {
        ...
        "handlers.SubmitReportRequest": {
            ...
            "properties": {
                ...
                "severity": {
                    "description": "Severity affects triage ordering only; self-declaring critical never bypasses the provisional-visibility gate (internal/service.Severities).",
                    "type": "string",
                    "enum": [
                        "low",
                        "medium",
                ...
                "shelter_capacity_status": {
                    "description": "ShelterCapacityStatus is required when category is shelter_open and forbidden for every other category (internal/service.CapacityStatuses).",
                    "type": "string",
                    "enum": [
                        "available",
                        "limited",
                ...
                "shelter_headcount": {
                    "description": "ShelterHeadcount is optional and only valid alongside category shelter_open.",
                    "type": "integer",
                    "example": 42
                }
            }
